	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation">
			<div class="top">
				<div class="container">
					<div class="row">
						<div class="col-xs-4">
							<p class="site">www.bluesemtech.com</p>
						</div>
						<div class="col-xs-8 text-right">
							<p class="num">Call: +251 984 742593</p>
			...
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="index.html">BlueSem</a></div>
						</div>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(app/images/img_bg_5.jpg);">
			   	...
			   	<li style="background-image: url(app/images/img_bg_1.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
			   	...
			   	<li style="background-image: url(app/images/img_bg_3.jpg);">
			   		<div class="overlay"></div>
			   	...
			   	<li style="background-image: url(app/images/img_bg_4.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
					...
					<div class="col-md-12 animate-box">
						<div class="owl-carousel owl-carousel2">
							@foreach($rooms as $room)
								<div class="item">
									<a href="app/images/room-1.jpg" class="room image-popup-link" style="background-image: url({{$room->image}});"></a>
									<div class="desc text-center">
										...
										<h3><a href="rooms-suites.html">{{$room->type}}</a></h3>
										<p class="price">
										...
										<ul>
											<li><i class="icon-check"></i> {{$room->desc1}}</li>
											<li><i class="icon-check"></i> {{$room->desc2}}</li>
											<li><i class="icon-check"></i> {{$room->desc3}}</li>
										</ul>
										<p><a href="{{route('client.book', ['id' => $room->id])}}" class="btn btn-primary btn-book">Book now!</a></p>
									</div>
								</div>
							@endforeach
							<!-- <div class="item">
								<a href="app/images/room-2.jpg" class="room image-popup-link" style="background-image: url(app/images/room-2.jpg);"></a>
								<div class="desc text-center">
							...
							<div class="item">
								<a href="app/images/room-3.jpg" class="room image-popup-link" style="background-image: url(app/images/room-3.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
							...
							<div class="item">
								<a href="app/images/room-4.jpg" class="room image-popup-link" style="background-image: url(app/images/room-4.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
							...
							<div class="item">
								<a href="app/images/room-5.jpg" class="room image-popup-link" style="background-image: url(app/images/room-5.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
							...
							<div class="item">
								<a href="app/images/room-6.jpg" class="room image-popup-link" style="background-image: url(app/images/room-6.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
			...
			<div class="container">
				...
				<div class="row">
					<div class="diningbar-flex">
								...
								<div role="tabpanel" class="tab-pane active" id="mains">
									<div class="row">
										<div class="col-md-12">
											<ul class="menu-dish">
							              <li>
							                <figure class="image"><img src="app/images/menu-1.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="app/images/menu-2.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="app/images/menu-3.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="app/images/menu-4.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
								...
								<div role="tabpanel" class="tab-pane" id="drinks">
									<div class="row">
										<div class="col-md-12">
											<ul class="menu-dish">
							              <li>
							                <figure class="image"><img src="app/images/menu-8.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							              ...
							              <li>
							                <figure class="image"><img src="app/images/menu-9.jpg" alt="Free Bootstrap Template by colorlib.com"></figure>
							                <div class="text">
							                  <span class="price">$20.50</span>
							                  <h3>Tuna Roast Source</h3>
							                  <p class="cat">Tuna / Potatoes / Rice</p>
			         ...
			         <div class="half diningbar-img" style="background-image: url(app/images/cover_img_1.jpg);"></div><!-- end half -->
			      </div>
			   </div>
	      </div>
		</div>
		...
		<div id="colorlib-blog">
			<div class="container">
				...
				<div class="blog-flex">
					<div class="video colorlib-video" style="background-image: url(app/images/blog-3.jpg);">
						...
						<div class="row">
							<div class="col-md-12 animate-box">
								<a href="blog.html" class="blog-post">
									<span class="img" style="background-image: url(app/images/blog-1.jpg);"></span>
									<div class="desc">
							...
							<div class="col-md-12 animate-box">
								<a href="blog.html" class="blog-post">
									<span class="img" style="background-image: url(app/images/blog-2.jpg);"></span>
									<div class="desc">
										<span class="date">January 14, 2018</span>
							...
							<div class="col-md-12 animate-box">
								<a href="blog.html" class="blog-post">
									<span class="img" style="background-image: url(app/images/blog-3.jpg);"></span>
									<div class="desc">
										<span class="date">January 14, 2018</span>
			...
			<div class="container">
				...
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						<span class="img-user" style="background-image: url(app/images/person2.jpg);"></span>
				...
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						<span class="img-user" style="background-image: url(app/images/person1.jpg);"></span>
				...
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						<span class="img-user" style="background-image: url(app/images/person3.jpg);"></span>
		...
		<div id="colorlib-subscribe" style="background-image: url(app/images/img_bg_2.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading animate-box">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></small> 
	...
	<script src="app/js/magnific-popup-options.js"></script>
	<!-- Date Picker -->
